document.addEventListener('alpine:init', () => {
  ...
  Alpine.data('xVariantSelect', (
    ...
    _updateMedia() {
      if (this.currentVariant && this.currentVariant.featured_image != null && !chooseOption && !productBundle) {
  ...
  Alpine.data("xCounponCode", () => ({
    ...
    applyCouponCode(discountCode, isCart=false) {
      ...
      if (discountCode) {
        let discountCodes = [...appliedDiscountCodes, discountCode].join(",");
